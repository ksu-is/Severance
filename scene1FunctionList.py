                    ...
                    if input_text == "1":
                        if codeFound:
                            ...
                            while not inMainMenu:
                                surface.fill((0, 0, 0))
                                for i, line_surface in enumerate(text_surface1):
                                    surface.blit(line_surface, (pos[0], pos[1] + i * font.get_linesize()))
                                input_pos = (pos[0], pos[1] + (len(text_surface1) + 1) * font.get_linesize())
                                input_surface = font.render(input_text, True, color)
                                surface.blit(input_surface, input_pos)
                                pygame.display.flip()
                                for event in pygame.event.get():
                                    ...
                                    if event.type == pygame.KEYDOWN:
                                        if event.key == pygame.K_RETURN or event.key == pygame.K_KP_ENTER:
                                            if "concious" or "conscious" in input_text.lower():
                                                input_text = ""
                        ...
                        if codeFound:
                            ...
                            while not inMainMenu:
                                surface.fill((0, 0, 0))
                                for i, line_surface in enumerate(text_surface2):
                                    surface.blit(line_surface, (pos[0], pos[1] + i * font.get_linesize()))
                                input_pos = (pos[0], pos[1] + (len(text_surface2) + 1) * font.get_linesize())
                                input_surface = font.render(input_text, True, color)
                                surface.blit(input_surface, input_pos)
                                pygame.display.flip()
                                for event in pygame.event.get():
